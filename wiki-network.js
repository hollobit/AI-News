(() => {
  ...
  let data=null,snapshot=null,selected='',limit=100,request=0,zoom=1,panX=0,panY=0,drag=null,suppressClick=false,viewMode='3d',cameraPose={};
  ...
  window.atlas3DFailed=message=>{setMode('2d');$('status').textContent=message;saveURL(false);};
